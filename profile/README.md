...
2. Install [online client](https://github.com/mcnckc/ton-airgap-client) on your android device. Read [this](https://github.com/ton-offline-storage/.github/blob/main/profile/README.md#android-client-alternative) if you don't have an android device
